export const focusCopy = {
  en: {
    ...
    list: {
      ...
      historyEmptyDescription: "Finished study sessions and saved focus runs will appear here.",
      details: "Details",
      filters: {
        status: "Status",
  ...
  "pt-BR": {
    ...
    list: {
      ...
      historyEmptyDescription: "Sessoes concluidas e execucoes salvas aparecerao aqui.",
      details: "Detalhes",
      filters: {
        status: "Status",
